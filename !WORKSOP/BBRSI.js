...
method.log = function (candle) {
  ...
  // console.log(
  //   'outlog:',
  //   'candle', this.nsamples,
  //   'price', candle.close.toFixed(digits),
  //   'up', BB.upper.toFixed(digits),
  //   'mid', BB.middle.toFixed(digits),
  //   'low', BB.lower.toFixed(digits)
  // );
...
method.check = function (candle) {
  ...
  if (price <= BB.lower && rsiVal <= this.settings.thresholds.low && this.trend.duration >= this.settings.thresholds.persistence) {
    ...
    //);
    log.debug('>>>>>', this.name, 'buying...', price);
    this.advice('long')
  }
  if (price >= BB.middle && rsiVal >= this.settings.thresholds.high) {
    ...
    //);
    log.debug('>>>>>', this.name, 'selling...', price);
    this.advice('short')
  }
