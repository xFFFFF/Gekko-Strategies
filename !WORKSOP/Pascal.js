...
method.check = function() {
    ...
    if(macddiff > settings.thresholds.up && rsiVal < settings.thresholds.low) {
        // new trend detected
    ...
    } else if(macddiff < settings.thresholds.down && rsiVal > settings.thresholds.high) {
        // new trend detected
